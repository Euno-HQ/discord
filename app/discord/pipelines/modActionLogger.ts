  ...
  yield* stream.pipe(
    Stream.filter(
      (e) =>
        ...
        e.type === "AutoModerationRuleCreate" ||
        e.type === "AutoModerationRuleDelete" ||
        e.type === "AutoModerationRuleUpdate",
    ),
      ...
      const handler = (() => {
        switch (e.type) {
          ...
          case "AutoModerationRuleCreate":
            return logAutomodRuleCreate(e.rule);
          case "AutoModerationRuleDelete":
            return logAutomodRuleDelete(e.rule);
          case "AutoModerationRuleUpdate":
            return logAutomodRuleUpdate(e.oldRule, e.newRule);
          default:
            return Effect.void;
        }
      })();
